...
const FlightSearchForm: FC<FlightSearchFormProps> = () => {
  ...
  // guestChildrenInputValue +  + guestInfantsInputValue;
  ...
  const renderForm = () => {
    return (
      <div>
        {renderRadioBtn()}
        <form className="w-full relative mt-8 rounded-[40px] xl:rounded-[49px] rounded-t-2xl xl:rounded-t-3xl shadow-xl dark:shadow-2xl bg-white dark:bg-neutral-800 mb-8">
