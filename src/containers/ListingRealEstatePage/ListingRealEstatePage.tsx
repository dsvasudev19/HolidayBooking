...
const DEMO_CATS: TaxonomyType[] = [
  {
    ...
    taxonomy: "category",
    title: "Enjoy the Beauty of Brazil ",
  ...
  },
  {
    ...
    title: "Enjoy the Beauty of Paris",
    featuredPropertyMedia: { path: "" },
    taxonomy: "category",
    count: 2118,
    thumbnail:
  ...
  },
  {
    ...
    title: "Enjoy the Beauty of Bangkok",
    featuredPropertyMedia: { path: "" },
    taxonomy: "category",
    count: 36612,
    thumbnail:
  ...
  },
  {
    ...
    title: "Enjoy the Beauty of Singapore",
    featuredPropertyMedia: { path: "" },
    taxonomy: "category",
    count: 188288,
    thumbnail:
  ...
  },
  {
    ...
    title: "Enjoy the Beauty of Seoul",
    featuredPropertyMedia: { path: "" },
    city: "Goa",
    taxonomy: "category",
    count: 188288,
