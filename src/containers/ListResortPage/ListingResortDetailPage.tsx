...
import { Resort_demos, ResortPhotos } from "containers/ListResortPage/Resorts";
      ...
      <div className="listingSection__wrap !space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <span>
            ...
            <span className="ml-1"> Vagator Beach, North Goa</span>
          </span>
        </div>
        ...
        <div className="flex items-center justify-between xl:justify-start space-x-8 xl:space-x-12 text-sm text-neutral-700 dark:text-neutral-300">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className=" ">
              6 <span className="hidden sm:inline-block">Rooms</span>
            </span>
          </div>
          <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className=" ">
              3 <span className="hidden sm:inline-block">bedrooms</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col sm:rounded-2xl lg:border border-neutral-200 dark:border-neutral-700 space-y-10 sm:space-y-8 px-0 sm:p-6 xl:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center">
          ...
          <div className=" w-full sm:w-4/5 mt-[-0.5rem]">
            <div className="text-2xl font-semibold mb-3">Luxuary Suite ✅</div>
          ...
          <div className="flex-shrink-0 w-full sm:w-1/6 mt-3">
            <div className="aspect-w-4 aspect-h-3 sm:aspect-h-4 rounded-2xl overflow-hidden">
              <img
                ...
                sizes="200px"
                src="https://cache.marriott.com/content/dam/marriott-renditions/GOIWH/goiwh-suite-room-3532-hor-clsc.jpg?output-quality=70&interpolation=progressive-bilinear&downsize=1215px:*"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="font-semibold px-2">₹ 7,500</span>
        </div>
      </div>
    );
  };
      ...
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <span>
            ...
            Radisson Blu Resort Goa Cavelossim Beach—an inspiring blend of Goan
            architecture and Portuguese culture. Make the easy, 45-minute
            commute from Dabolim International Airport (GOI), and allow the
            stress of everyday life to melt away in our stunning accommodations.
            Rest up and relax in 132 rooms and suites with private balconies,
            complemented perfectly with our on-site SOHUM spa, relaxing
            free-form pool, and gourmet restaurants.
          </span>
          <br />
          <br />
          <span>
  ...
  const renderSection3 = () => {
    return (
      <div className="listingSection__wrap">
        ...
        <div className="w-14 border-b border-neutral-200 dark:border-neutral-700"></div>
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 text-sm text-neutral-700 dark:text-neutral-300 ">
          {Resort_demos.filter((_, i) => i < 12).map((item) => (
              ...
              <div className="inline-block py-8 h-screen w-full max-w-4xl">
                <div className="inline-flex pb-2 flex-col w-full text-left align-middle transition-all transform overflow-hidden rounded-2xl bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 dark:text-neutral-100 shadow-xl h-full">
                  ...
                  <div className="px-8 overflow-auto text-neutral-700 dark:text-neutral-300 divide-y divide-neutral-200">
                    {Resort_demos.filter((_, i) => i < 1212).map((item) => (
                      <div
                        key={item.name}
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <span className="block text-neutral-6000 dark:text-neutral-300">
          W Goa is a stylish and trendy resort in Vagator, North Goa, offering a
          blend of modern design, luxury amenities, and proximity to Vagator
          Beach.
        </span>
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div>
          ...
          <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
            W Resort Near to Vagator Beach (North Goa)
          </span>
        </div>
        ...
        <div className="aspect-w-5 aspect-h-5 sm:aspect-h-3 ring-1 ring-black/10 rounded-xl z-0">
          <div className="rounded-xl overflow-hidden z-0">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3842.7975169542397!2d73.73436741123896!3d15.602463584948962!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfe96f8008739f%3A0x466052ed5d25e27e!2sW%20Goa!5e0!3m2!1sen!2sin!4v1706693214671!5m2!1sen!2sin"
            ></iframe>
          </div>
        </div>
      </div>
    ...
    <div className="nc-ListingStayDetailPage">
      ...
      <header className="rounded-md sm:rounded-xl">
        <div className="relative grid grid-cols-3 sm:grid-cols-4 gap-1 sm:gap-2">
          ...
          {ResortPhotos.filter((_, i) => i >= 1 && i < 5).map((item, index) => (
            <div
              key={index}
